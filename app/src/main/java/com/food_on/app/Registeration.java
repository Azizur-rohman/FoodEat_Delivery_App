...
public class Registeration extends AppCompatActivity {
    ...
    String[] Dhaka= {"Dhaka", "Faridpur", "Gazipur", "Gopalganj", "Kishoreganj", "Manikganj", "Madaripur", "Munshiganj", "Narayanganj", "Narsingdi",
            "Rajbari", "Shariatpur", "Tangail"};
    String[] Chittagong = {"Bandarban", "Brahmanbaria", "Chandpur", "Chittagong", "Comilla", "Cox's Bazar", "Feni", "Khagrachhari", "Lakshmipur", "Noakhali",
            "Rangamati"};
    String[] Rajshahi = {"Bogura", "Chapainawabganj", "Joypurhat", "Naogaon", "Natore", "Pabna", "Rajshahi", "Sirajgonj"};
    String[] Barishal = {"Barisal", "Barguna", "Bhola", "Jhalokati", "Patuakhali", "Pirojpur"};
    ...
    String[] Dhakadis = {"Dhamrai", "Dohar", "Keraniganj", "Nawabganj", "Savar"};
    String[] Faridpur = {"Alfadanga", "Bhanga", "Boalmari", "Charbhadrasan", "Faridpur Sadar", "Madhukhali", "Nagarkanda", "Sadarpur", "Saltha"};
    String[] Rajshahidis = {"Bagha", "Baghmara", "Charghat", "Durgapur", "Godagari", "Mohanpur", "Paba", "Puthia", "Tanore"};
    String[] Chapainawabganj = {"Bholahat", "Chapai Nawabganj Sadar", "Gomastapur", "Nachole", "Shibganj"};
    String[] Chittagongdis = {"Anwara", "Banshkhali", "Boalkhali", "Chandanaish", "Fatikchhari",
            "Hathazari", "Karnaphuli", "Lohagara", "Mirsharai", "Patiya", "Rangunia", "Raozan", "Sandwip", "Satkania",
            "Sitakunda"};
        ...
        try {
            ...
            City.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    if (cityy.equals("Dhaka")) {
                        ArrayList<String> listt = new ArrayList<>();
                        for (String text : Dhakadis) {
                            listt.add(text);
                        }
                    ...
                    if (cityy.equals("Chapainawabganj")) {
                        ArrayList<String> listt = new ArrayList<>();
                        for (String text : Chapainawabganj) {
                            listt.add(text);
                        }
                        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Registeration.this, android.R.layout.simple_spinner_item, listt);
                        Suburban.setAdapter(arrayAdapter);
